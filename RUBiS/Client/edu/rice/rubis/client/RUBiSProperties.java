...
public class RUBiSProperties
{
  ...
  public URLGenerator checkPropertiesFileAndGetURLGenerator()
  {
    try
    {
      ...
      floo = new Float(getProperty("workload_session_slowdown_factor"));
      //sessionSlowDown = floo.intValue();
      sessionSlowDown = floo.floatValue();
  ...
  public float getSessionTimeSlowdown(){
    return sessionSlowDown;
  }
