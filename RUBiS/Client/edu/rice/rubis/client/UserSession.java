...
public class UserSession extends Thread
{
  ...
  private int extractItemIdFromHTML()
  {
    ...
    Integer foo =  Integer.valueOf(lastHTMLReply.substring(keyIndex+7, lastIndex));
  ...
  private int extractPageFromHTML()
  {
    ...
    Integer foo = Integer.valueOf(lastHTMLReply.substring(chosenIndex+6, lastIndex));
    return foo.intValue();
  }
  ...
  private int extractIntFromHTML(String key)
  {
    ...
    Integer foo = Integer.valueOf(lastHTMLReply.substring(keyIndex+key.length(), lastIndex));
  ...
  private float extractFloatFromHTML(String key)
  {
    ...
    Float foo = Float.valueOf(lastHTMLReply.substring(keyIndex+key.length(), lastIndex));
