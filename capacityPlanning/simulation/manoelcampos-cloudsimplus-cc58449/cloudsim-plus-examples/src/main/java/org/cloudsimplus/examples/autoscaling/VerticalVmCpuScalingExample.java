...
public class VerticalVmCpuScalingExample {
    ...
    */
    ...
    private void onClockTickListener(EventInfo evt) {
        ...
        //availableResource: 
        //System.out.println(vmList.get(0).getResource(vmList.get(0).getPeVerticalScaling().getResourceClass()).getAllocatedResource());
    }
    ...
    private Cloudlet createCloudlet(final long length, final int numberOfPes, final double delay) {
        ...
        final UtilizationModel utilizationCpu = new UtilizationModelDynamic(1.0/2.0);
        /**
