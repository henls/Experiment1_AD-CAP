...
class Actor():
    def __init__(self):
        self.actor_estimate_eval = ActorNet(state_number,action_number)
        self.actor_reality_target = ActorNet(state_number,action_number)
        self.optimizer = torch.optim.Adam(self.actor_estimate_eval.parameters(), lr=LR_A)

    '''第二步 编写根据状态选择动作的函数, 无梯度的'''
...
if Switch==0:
    ...
    for episode in range(2000):
        ...
        if episode % 20 == 0 and episode > 100:#保存神经网络参数在电脑E盘
